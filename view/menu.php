...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark alt">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
                    ...
                    if(!isset($_SESSION['user'])){
                        ...
                        echo '<button class="btn btn-outline-success mr-sm-2  my-2 mg-3 my-sm-0" data-toggle="modal" data-target="#exampleModalCenter" type="button">Entrar</button>';
                ...
                <div class="modal-body">
                    <form action="..\control\logar.php " method="POST">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" placeholder="exemplo@email.com">
